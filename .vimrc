...
" Neovim LSP
" Courtesy of https://jose-elias-alvarez.medium.com/configuring-neovims-lsp-client-for-typescript-development-5789d58ea9c
lua << EOF
local lspconfig = require("lspconfig")local buf_map = function(bufnr, mode, lhs, rhs, opts)
